	...
	public class NPC_greykitten: MonoBehaviour
	{
		...
		IEnumerator Decision()
		{
			...
			decision = Random.Range(1,12);
				...
				switch (decision)
				{
					...
					if((Mathf.Pow(movement, 2)) > 1.5f)
					{
						Debug.Log("Running!!");
						animator.SetFloat("Speed", 3);
						animator.SetFloat("Idle", 0f);
						movement = (Random.Range(2f,3f));	
					}						
