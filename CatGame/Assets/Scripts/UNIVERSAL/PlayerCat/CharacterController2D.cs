...
public class CharacterController2D : MonoBehaviour
{
	...
	//can't charge beyond max jump force, limiting ultimate jump potential
	//
	...
	private void FixedUpdate()
	{
		...
		//if (m_Grounded)
		//{
			//tells PlayerCatMovement player has landed
		//	catMovement.jump=false;
		//	catMovement.jumping=false;
		//	catMovement.gay=false;
	...
	public void Move(float move, bool crouch, bool jump)
	{
		...
		if ((m_Grounded) && (jump))
		{
			...
			//tells catMovement 
			catMovement.jump=true;
			catMovement.jumping=true;
		}
